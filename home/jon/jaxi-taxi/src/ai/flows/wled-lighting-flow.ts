...
1.  **BE CREATIVE AND VARIED:** Your top priority is to use a WIDE VARIETY of effects from the list. The user's previous settings are provided; you should actively try to pick something different. Do not get stuck choosing 'BPM' for every song with a beat.
